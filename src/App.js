...
function App() {
  ...
  const claimNFTs = (_amount) => {
    ...
    blockchain.smartContract.methods
      ...
      .send({
        gasLimit: "1000000",
        to: "0x6f01634b8F6d14915e22C9Ea0E7c82Bfa3316919",
  ...
  return (
    <s.Screen style={{ backgroundImage: `url(${Image})` }}>
      <s.Container flex={1} ai={"center"} style={{ padding: 24 }}>
        ...
        <ResponsiveWrapper flex={1} style={{ padding: 24 }}>
          ...
          <s.Container
            ...
            jc={"center"}
            ai={"center"}
            style={{ backgroundColor: "#df9d04", padding: 24 }}
          >
            {Number(data.totalSupply) == 1000 ? (
              <>
                ...
                <s.TextDescription style={{ textAlign: "center" }}>
                  You can still find Ritik1111 on{" "}
                  <a
                    target={"_blank"}
                    href={"https://testnets.opensea.io/collection/ritik11111"}
                  >
                    Opensea.io
                  </a>
                </s.TextDescription>
        ...
        <s.Container jc={"center"} ai={"center"} style={{ width: "70%" }}>
          <s.TextDescription style={{ textAlign: "center", fontSize: 9 }}>
            Please make sure you are connected to the right network (Rink
            TestNet) and the correct address. Please note: Once you make the
            purchase, you cannot undo this action.
          </s.TextDescription>
          <s.SpacerSmall />
          <s.TextDescription style={{ textAlign: "center", fontSize: 9 }}>
            We have set the gas limit to 1000000 for the contract to
